...
const Administrador_1 = require("./routes/Administrador");
...
class Server {
    ...
    constructor() {
        ...
        this.paths = {
            administradores: '/api/inversionistas',
        };
    ...
    routes() {
        this.app.use(this.paths.administradores, Administrador_1.router);
    }
    listen() {
        this._express.listen(this.port, () => {
            console.log(`Servidor ejecutando 
            en http://localhost:${this.port}/v1/sextoa/api/inversionistas`);
        });
    }
}
